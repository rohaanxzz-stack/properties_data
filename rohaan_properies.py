...
# ============================================
# 🛡️ ACCESS CONTROL (Editors vs. Viewers)
# ============================================
...
def load_all_data():
    try:
        ...
        # 🛡️ THE FIX: If table is empty, initialize columns manually
        if df_p.empty:
        ...
        num_cols = ["buying_price", "construction_cost", "total_profit", "selling_price"]
        for col in num_cols:
